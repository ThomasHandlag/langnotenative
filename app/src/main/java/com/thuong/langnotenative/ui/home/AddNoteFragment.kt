...
class AddNoteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        with(binding) {
            ...
            centeredBtn.setOnClickListener {
                if (viewModel._selectedViewId.value == binding.subjEditText.id.toString()) {
                        subjEditText.gravity = Gravity.CENTER_HORIZONTAL
                } else if (viewModel._selectedViewId.value == binding.contEditText.id.toString()) {
            ...
            subjEditText.setOnFocusChangeListener { it, _ ->
                viewModel._selectedViewId.value = it.id.toString()
            }
    ...
    override fun onDestroy() {
        super.onDestroy()
        viewModel._selectedViewId.value = ""
    }
}